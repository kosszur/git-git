...
NAME
----
gitformat-index - A Git index formátuma
...
A Git index formátuma

[[_the_git_index_file_has_the_following_format]]
== A Git indexfájljának a következő formátuma van
...
Az egyes könyvtárblokkok fennmaradó adatai típus szerint csoportosítva:
